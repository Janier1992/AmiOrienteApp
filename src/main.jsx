...
const logPWA = (msg, data = '') => {
  if (DEBUG_PWA) console.log(`%c📱 PWA: ${msg}`, 'background: #16a34a; color: white; padding: 2px 5px; border-radius: 2px;', data);
};

// 1. Check Manifest Availability with correct content-type check
if (DEBUG_PWA) {
  fetch('/manifest.json')
    .then(res => {
