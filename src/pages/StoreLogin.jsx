          ...
          >
            ...
            <Card className="w-full bg-card text-card-foreground border-border">
              <CardHeader className="text-center pb-6">
                ...
                <CardTitle className="text-2xl font-bold">Acceso para Negocios</CardTitle>
              ...
              <CardContent>
                ...
                <div className="mt-6 text-center text-sm">
                  <p className="text-muted-foreground">
                    ...
                    <Link to="/servicios/registro" className="font-semibold text-primary hover:text-primary/80">
                      Regístrate aquí
                    </Link>
                  </p>
                </div>
